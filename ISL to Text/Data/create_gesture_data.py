...
while True:
    ...
    # Time to configure the hand specifically into the ROI...
        ...
        cv2.putText(frame_copy, "Adjust your hand to record gesture for" + str(element), (200, 400), cv2.FONT_HERSHEY_SIMPLEX, 1,
                    (0, 255, 0), 2)
        ...
        if hand is not None:
            ...
            if num_imgs_taken <= 300:
                cv2.imwrite(r"C:/Users/dubey/OneDrive/Desktop/Coding/Projects/ISL-to-Text-Converter/ISL self made dataset" + "\\" + str(
    ...
    cv2.putText(frame_copy, "Hand gesture dataset creation", (10, 20), cv2.FONT_ITALIC, 0.6, (51, 255, 51), 1)

    # increment the number of frames for tracking
    num_frames += 1

    # Display the frame with segmented hand
    cv2.imshow("Dataset creation", frame_copy)
