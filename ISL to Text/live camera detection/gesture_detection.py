...
# Ensure that the path is correct and the .keras file is compatible
try:
    # Use raw strings to avoid issues with backslashes
    model = tf.models.load_model(r"C:\Users\dubey\OneDrive\Desktop\Coding\Projects\ISL-to-Text-Converter\Models\ISL_model.keras")
...
converter = tf.lite.TFLiteConverter.from_saved_model('Projects\ISL-to-Text-Converter\Models\ISL_model.keras')
